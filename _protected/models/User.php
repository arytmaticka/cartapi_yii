 ...
 * @property int $has_cart
 *
 * @property CartsProducts[] $cartsProducts
...
class User extends UserIdentity {
    ...
    public function rules() {
        return [
            ...
            [['status', 'created_at', 'updated_at', 'has_cart'], 'integer'],
            ['email', 'unique',
...
//------------------------------------------------------------------------------------------------//
    ...
    public function getProducts() {
        return $this->hasMany(Products::className(), ['id' => 'products_id'])->viaTable('carts_products', ['user_id' => 'id']);
    }
