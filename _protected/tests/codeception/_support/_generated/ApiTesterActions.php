<?php  //[STAMP] da410620cb3564998ac09377d837e0e1
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::authenticateToApi()
     */
    public function authenticateToApi($username) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('authenticateToApi', func_get_args()));
    }
     ...
     */
    public function checkResponse($response, $code = null) {
